...
<div style="padding-left: 50px;"><br>
	<h1 style="font-size: 50px; font-family: sans-serif;" >Tambah Data </h1> <br><br>
</div>
         <main>
		<form class="formulir">
			<div class="row">
			...
			<div class="row">
				...
				<div class=" col-sm-8">
					<input type="textarea" name="" class="form-control" style="height: 200px">
				</div>
			</div>
			<div class="row">
				<div class=" col-sm-4 span">
			...
			<div class="row">
				...
				<div class=" col-sm-2">
					<button style="width: 100px; height: 30px" >Cancel</button>
				</div>
			</div>
