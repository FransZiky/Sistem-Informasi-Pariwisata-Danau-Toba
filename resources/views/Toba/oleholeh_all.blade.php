...
<main>
		<div class="row" > 
            ...
            <div class="col-lg-6" style="top: 50px;">
              <div class="card mb-4 box-shadow" style="border: none;">
                <a href="museum_tb.html">
                  <img src="image/tobasa/tradisional.jpg" style="width: 100%;height: 300px;">
                  <p id="image_label" style="background-color: #A05968;height: 35px; width: 100%; padding-bottom: -20px;" ><span style="color: white; font-size: 18px;padding-left: 200px;">Pasar Tradisional</span></p>
                </a>
            ...
            <div class="col-lg-6" style="top: 50px;">
              <div class="card mb-4 box-shadow"style="border: none;">
                <a href="{{url('/batikta')}}" >
                  <img src="image/tobasa/batikta.jpg"  style="width: 100%;height: 300px;">
                  <p id="image_label" style="background-color: #A05968;height: 35px; width: 100%; padding-bottom: -20px;" ><span style="color: white; font-size: 18px;padding-left: 250px;">Batikta</span></p>
                </a>
              </div>
            </div>
            ...
            <div class="col-lg-6" style="top: 50px;">
              <div class="card mb-4 box-shadow"style="border: none;" >
                <a href="#">
                  <img src="image/tobasa/batikta.jpg"  style="width: 100%;height: 300px;">
                  <p id="image_label" style="background-color: #A05968;height: 35px; width: 100%; padding-bottom: -20px;" ><span style="color: white; font-size: 18px; padding-left: 230px;">Batikta</span></p>
                </a>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                    </div>
            ...
            <div class="col-lg-6" style="top: 50px;">
              <div class="card mb-4 box-shadow"style="border: none;">
                <a href="#">
                  <img src="image/tobasa/batikta.jpg"  style="width: 100%;height: 300px;">
                  <p id="image_label" style="background-color: #A05968;height: 35px; width: 100%; padding-bottom: -20px;" ><span style="color: white; font-size: 18px;padding-left: 200px;">Batikta</span></p>
                  </a>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                    </div>
