		...
		<div class="row" > 
			...
			<h1 style="text-align: center;padding-top: 20px;">
				...
				<div style="text-align: center;">
					<a href="{{url('/destinasi_all')}}"><button  style="height: 30px; width: 90px; background-color: #A05968;color: black;">ALL</button></a>
					<a href="{{url('/destinasi_alam')}}"><button style="height: 30px; width: 90px;color: black;">ALAM</button></a>
					<a href="{{url('/destinasi_rohani')}}"><button style="height: 30px; width: 90px;color: black;">ROHANI</button></a>
					<a href="{{url('/destinasi_budaya')}}"><button style="height: 30px; width: 90px;color: black;">SEJARAH</button></a>
				</div>
