		...
		<div class="row" > 
			...
			<h1 style="text-align: center;padding-top: 20px;">
				...
				<div style="text-align: center;">
					<a href="{{url('/umum_all')}}"><button  style="height: 30px; width: 90px; background-color: #A05968;color: black;">ALL</button></a>
					<a href="{{url('/umum_bank')}}"><button style="height: 30px; width: 90px;color: black;">BANK</button></a>
					<a href="{{url('/umum_pos')}}"><button style="height: 30px; width: 90px;color: black;">POS </button></a>
            ...
            <div class="col-lg-6" style="top: 50px;">
              <div class="card mb-4 box-shadow" style="border: none;">
                <a href="museum_tb.html">
                  ...
                  <p id="image_label" style="background-color: #A05968;height: 35px; width: 100%; padding-bottom: -20px;" ><span style="color: white; font-size: 18px;padding-left: 200px;">Taman Eden</span></p>
                </a>
