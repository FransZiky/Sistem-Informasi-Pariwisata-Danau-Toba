		...
		<div class="row" > 
			...
			<h1 style="text-align: center;padding-top: 20px;">
				...
				<div style="text-align: center;">
					<a href="{{url('/kuliner_all')}}"><button  style="height: 30px; width: 90px; background-color: #A05968;color: black;">ALL</button></a>
					<a href="{{url('/kuliner_rm')}}"><button style="height: 30px; width: 95px;color: black;">RUMAH MAKAN</button></a>
